...
import { rectStyles, spinnerRecipe, spinnerStyle } from './LoadingSpinner.css';

export interface ILoadingSpinner extends BaseProps, VariantProps<typeof spinnerRecipe> {
  className?: string;
}
